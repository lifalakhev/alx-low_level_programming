...
/**
 * print_error_and_exit -Func that print error message to stderr and exit
 * @exit_code: exit code
...
/**
 * print_hex - Function print the hex values of a buffer
...
/**
 * print_elf_header - Func print the ELF header information
 * @buffer: The buffer containing ELF header
 */
void print_elf_header(uint8_t *buffer)
{
	printf("ELF Header:\n");
